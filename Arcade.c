...
int main()
{
    ...
    while (check == 1)
    {
        ...
        printf("\n====== BEM-VINDO ======\n");
        printf("\n==== BOLL's ARCADE ====\n");
        printf("\nEscolha um dos dois jogos:\n\n 1 - Quiz sobre Video Games;\n-->Um jogo de 5 perguntas sobre personagens de varios titulos conhecidos pelo mundo todo; \n\n 2 - Jogo das Cobras;\n-->Este e um jogo para DOIS voce e seu amigo escolhem em turnos entre 5 caixas diferentes onde voce pode tanto ganhar ou encontrar algo terrivel; \n\n 3 - Sair do Arcade\n\n Selecione uma opcao: \n");
        scanf("%d", &escolha);
        ...
        case 1: // QUIZ SOBRE VIDEO GAMES
            ...
            printf("\nQual e o nome do pesonagem principal de Resident Evil: 4 ?\n 1) Ashley\n 2) Leon\n 3) Chris\n 4) Ada\n");
            scanf("%d", &resp);
            if (resp == 2)
            {
                printf("\nACERTOU!!!\n");
            ...
            {
                printf("\nERROU\n\nA resposta certa era 2) Leon\n");
            }
            
            
            resp = 0;
            printf("\nQual e o nome do personagem principal de Metal Gear Solid: 5?\n 1) Solid Snake\n 2) Big Boss\n 3) Venom Snake\n 4) Raiden\n");
            scanf("%d", &resp);
            if (resp == 1)
            {
                printf("\nACERTOU!!!\n");
            ...
            {
                printf("\nERROU\n\nA resposta certa era 1) Solid Snake\n");
            }
            
            resp = 0;
            printf("\nQual e o nome do personagem principal de The Legend of Zelda: Breath of the Wild?\n 1) Link\n 2) Zelda\n 3) Ganon\n 4) Sheik\n");
            scanf("%d", &resp);
            if (resp == 1)
            {
                printf("\nACERTOU!!!\n");
            ...
            {
                printf("\nERROU\n\nA resposta certa era 1) Link\n");
            }
            
            resp = 0;
            printf("\nQual e o nome do personagem principal de God of War?\n 1) Kratos\n 2) Zeus\n 3) Ares\n 4) Poseidon\n");
            scanf("%d", &resp);
            if (resp == 1)
            {
                printf("\nACERTOU!!!\n");
            ...
            {
                printf("\nERROU\n\nA resposta certa era 1) Kratos\n");
            }
            
            resp = 0;
            printf("\nQual e o nome do personagem principal de Final Fantasy VII?\n 1) Cloud\n 2) Tifa\n 3) Aerith\n 4) Barret\n");
            scanf("%d", &resp);
            if (resp == 1)
            {
                printf("\nACERTOU!!!\n");
